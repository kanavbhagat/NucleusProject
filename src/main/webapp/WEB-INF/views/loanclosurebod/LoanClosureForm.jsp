...
<!-- Form Container -->
<div class="container-fluid">
    <form  action="" name="closureForm" id="closureForm" onsubmit="return onsubmitform();" method="get">
        <div class="row">
            <div class="col-sm-3">
...
<script>
    ...
    function onsubmitform() {
        if(document.getElementById("customerCode").value != "") {
            document.closureForm.action ="customerLoanClosures";
        }
        else
        if(document.getElementById("loanApplicationNumber").value != "") {
            document.closureForm.action ="loanClosureDetails";
        }
        return true;
    }
</script>

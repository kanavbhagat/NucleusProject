	...
	<div class="container pt-4 ">
		<div class="jumbotron text-center" style="background-color:rgba(255,82,82 ,0.4);">
              ...
              <div class="d-flex justify-content-center">
                ...
                <strong>LoanApplication ID : </strong> ${loanApplicationNumber}</p>

              </div>
              <%-- Put your link in the value field below where you want to redirect to. --%>
              <div class="d-flex justify-content-center">
                    <c:url var="mainUrl" value="/getRepaymentScheduleReportSearchPage" />
                    <a href="${mainUrl}">
                    <button class="btn btn-danger">Search Repayment Schedule</button>
                    </a>
              </div>
		</div>
	</div>

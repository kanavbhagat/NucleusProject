...
<body>
	...
	<div class="container pt-4 ">
		<div class="jumbotron text-center" style="background-color:rgba(141, 181, 150, 0.3);">
              ...
              <h1 class="display-4"> Policy Edited Successfully.</h1>

              <%-- Insert Message Desc Here --%>
              <p class="lead"><strong>Your Repayment Policy has been edited successfully.</strong></p>
              ...
              <div class="d-flex justify-content-center">
                ...
                <strong>Policy Code : </strong> ${policyCode}</p>
              ...
              <div class="d-flex justify-content-center">
                    ...
                    <a href="${mainUrl}">
                    <button class="btn btn-info">Go To Repayment Policy List</button>
                    </a>
              </div>
		</div>
	</div>

...
<div class="container-fluid">
<c:url var="saveUrl" value="/showRepaymentPolicy/add" />
    <form:form modelAttribute="newRepaymentPolicy" method="POST" action="${saveUrl}">
        <div class="row">
            <div class="col-sm-3">
...
<hr width="" color="#b3b3b3">
    <div class="row" style="margin-bottom:20px">
        <div class="col-sm-3 offset-sm-9">
            ...
            <input type="submit" class="btn btn-primary" name="saveApprove" value="Save & Request Approval" />
        </div>
    </div>

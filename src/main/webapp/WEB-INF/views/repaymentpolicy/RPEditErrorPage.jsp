...
<body>
	...
	<div class="container pt-4 ">
		<div class="jumbotron text-center" style="background-color:rgba(255,82,82 ,0.4);">
              ...
              <p class="lead">Repayment Policy could <strong>Not </strong> be edited.</p>
              ...
              <div class="d-flex justify-content-center">
                ...
                <strong>Policy Name Already exists.</p>
              ...
              <div class="d-flex justify-content-center">
                    ...
                    <a href="${mainUrl}">
                    <button class="btn btn-danger">Go back to Repayment Policies Page.</button>
                    </a>
              </div>
		</div>
	</div>

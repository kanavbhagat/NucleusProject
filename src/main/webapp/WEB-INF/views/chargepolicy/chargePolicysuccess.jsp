...
<body>
	...
	<div class="container pt-4 ">
		<div class="jumbotron text-center" style="background-color:rgba(141, 181, 150, 0.3);">
              ...
              <h1 class="display-4"> Charge Policy added successfully</h1>

              <%-- Insert Message Desc Here --%>
              <p class="lead"><strong>Charge Policy has been added successfully.</strong></p>
              ...
              <div class="d-flex justify-content-center">
                ...
                <strong>Eligibility Parameter Code : </strong> ${chargePolicyCode}</p>
              ...
              <div class="d-flex justify-content-center">
                    ...
                    <button class="btn btn-info">Go To Charge Policy Search Screen</button>
                    </a>
              </div>
		</div>
	</div>

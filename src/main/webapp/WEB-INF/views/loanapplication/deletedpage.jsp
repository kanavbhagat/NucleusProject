...
<body>
	...
	<div class="container pt-4 ">
		<div class="jumbotron text-center" style="background-color:rgba(141, 181, 150, 0.3);">
              ...
              <h1 class="display-4"> Application Deleted Successfully.</h1>

              <%-- Insert Message Desc Here --%>
              <p class="lead"><strong>Your Application has been deleted successfully.</strong></p>
              ...
              <div class="d-flex justify-content-center">
                    ...
                    <a href="${mainUrl}">
                    <button class="btn btn-info">Go To Applications</button>
                    </a>
              </div>
		</div>
	</div>
